...
if st.button(f"🔄 【{selected_shop}】の最新データを一括自動スキャン", type="primary"):
    with st.spinner(f"⏳ ネット上の【{selected_shop}】フォルダからデータを取得中..."):
        try:
            ...
            api_url = f"https://raw.github.com/repos/{GITHUB_USER}/{GITHUB_REPO}/contents/{folder_name}"
            ...
            for fname in target_files:
                ...
                file_raw_url = f"https://raw.githubusercontent.com/{GITHUB_USER}/{GITHUB_REPO}/{GITHUB_BRANCH}/{folder_name}/{fname}"
